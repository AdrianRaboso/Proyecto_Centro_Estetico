...
public class CrearTratamientoActivity extends AppCompatActivity {
    ...
    private void subirImagen(final Tratamiento nuevoTra) {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://centro-estetico.appspot.com/");
        ...
        try {
            ...
            //UploadTask uploadTask = riversRef.putFile(pathImagen);
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Snackbar.make(getCurrentFocus(), "Ha habido un error al subir la imagen, intentelo de nuevo", Snackbar.LENGTH_SHORT)
                            .setAction("Action", null).show();
                }
